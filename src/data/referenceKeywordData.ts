...
export const referenceCategories: ReferenceCategoryDefinition[] = [
  ...
  },
  {
    ...
    groups: [
      ...
      { label: '핵심 무드', keywords: ['모던', '클래식', '내추럴', '따뜻한', '감성', '러블리', '깔끔', '화려한', '빈티지'] },
      { label: '빛·컬러', keywords: ['자연광', '화이트톤', '비비드', '밝은', '고채도', '초록', '흑백'] },
      { label: '공간·장면', keywords: ['심플 배경', '실내 세트', '정원', '자연', '도시', '한옥', '분수', '아치', '저택', '루프탑', '온실', '도로'] },
