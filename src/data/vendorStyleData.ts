...
export const vendorStyleProfiles: VendorStyleProfile[] = [
  ...
  createProfile({ id: 'vp-m1', name: '김청경 헤어페이스', account: 'kimchungkyung_hairface', category: '헤어&메이크업', location: '청담동', priceRange: '130–190만원', summary: '생기 있는 컬러와 단정한 피부 표현을 신부 톤에 맞게 조율하는 숍', sampleCount: 15, primaryStyle: '과즙', primaryShare: .357, profileType: '균형형', styleCounts: { 과즙: 5, 깔끔: 4, 누디: 4, 강하게: 1 }, imagePosition: '50% 35%' }),
  createProfile({ id: 'vp-m2', name: '라메종 브라이드', account: 'lamaison_bride', category: '헤어&메이크업', location: '청담동', priceRange: '140–210만원', summary: '맑은 피부와 생기 있는 컬러가 분명한 과즙 메이크업 전문 숍', sampleCount: 31, primaryStyle: '과즙', primaryShare: .824, profileType: '집중형', styleCounts: { 과즙: 14, 누디: 2, 깔끔: 1 }, imagePosition: '44% 31%' }),
  createProfile({ id: 'vp-m3', name: '포레 웨딩', account: 'lkmforetwedding', category: '헤어&메이크업', location: '신사동', priceRange: '120–180만원', summary: '결을 깔끔하게 정돈하면서 누디 톤의 깊이를 살리는 메이크업', sampleCount: 16, primaryStyle: '깔끔', primaryShare: .533, profileType: '집중형', styleCounts: { 깔끔: 8, 누디: 5, 과즙: 2 }, imagePosition: '56% 35%' }),
  createProfile({ id: 'vp-m4', name: '미파레 웨딩', account: 'me.parer_wedding', category: '헤어&메이크업', location: '청담동', priceRange: '125–185만원', summary: '과즙과 누디 무드를 같은 비중으로 다뤄 상담 선택지가 넓은 숍', sampleCount: 17, primaryStyle: '과즙', primaryShare: .4, profileType: '균형형', styleCounts: { 과즙: 6, 누디: 6, 강하게: 2, 깔끔: 1 }, imagePosition: '62% 36%' }),
  createProfile({ id: 'vp-m5', name: '밈 웨딩', account: 'mimm_wedding', category: '헤어&메이크업', location: '논현동', priceRange: '115–175만원', summary: '맑은 생기와 깔끔한 윤곽을 균형 있게 제안하는 메이크업숍', sampleCount: 21, primaryStyle: '과즙', primaryShare: .429, profileType: '균형형', styleCounts: { 과즙: 9, 깔끔: 9, 누디: 3 }, imagePosition: '38% 33%' }),
]
