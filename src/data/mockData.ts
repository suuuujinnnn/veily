...
export const contracts: Contract[] = [
  ...
  { id: 'ct2', coupleId: 'c1', vendorId: 'v1', vendorName: '르블랑 브라이드', category: '드레스', contractDate: '2026-05-03', productName: '촬영·본식 드레스 패키지', packageDetails: '본식 1벌 · 촬영 3벌 · 2차 피팅', paymentMethod: '계좌이체', vatType: '별도', totalPrice: 3200000, commission: 320000, deposit: 800000, paymentDate: '2026-05-03', status: '확인필요', contractFile: '르블랑_계약서.pdf', memo: 'VAT 별도 확인 필요' },
  { id: 'ct3', coupleId: 'c2', vendorId: 'v3', vendorName: '오브제 스튜디오', category: '스튜디오', contractDate: '2026-07-02', productName: '스튜디오 촬영 패키지', packageDetails: '원본 전체 · 수정본 20P · 앨범 2권', paymentMethod: '카드', vatType: '포함', totalPrice: 2150000, commission: 215000, deposit: 500000, paymentDate: '2026-07-02', status: '결제대기', contractFile: '', memo: '촬영일 잔금 결제' },
...
export const initialPayments: Payment[] = [
  ...
  { id: 'pay2', coupleId: 'c1', paymentDate: '2026-05-03', type: '계약금', account: '르블랑 브라이드', amount: 800000, status: '입금완료', memo: '드레스 계약금' },
  { id: 'pay3', coupleId: 'c1', paymentDate: '2026-09-25', type: '잔금', account: '남산 라루체', amount: 15500000, status: '입금예정', memo: '본식 3주 전 안내' },
  { id: 'pay4', coupleId: 'c2', paymentDate: '2026-07-02', type: '계약금', account: '오브제 스튜디오', amount: 500000, status: '입금완료', memo: '' },
]
