...
import { ReferenceApiError, searchReferences, type ReferenceSearchResult } from '../../lib/referenceApi'
  ...
  useEffect(() => {
    ...
    searchReferences({ category, filters, q: debouncedQuery, limit: PAGE_SIZE, signal: controller.signal })
      ...
      .catch((cause: unknown) => {
        ...
        setError(cause instanceof ReferenceApiError ? cause.message : '레퍼런스를 불러오지 못했습니다.')
      })
      .finally(() => {
