...
import { ArrowRight, Bell, CalendarDays, Check, CheckCircle2, ChevronRight, Clock3, Heart, MapPin, MessageCircle, Pause, ReceiptText, Sparkles, ThumbsUp } from 'lucide-react'
...
export function PortalPage() {
  ...
  const { couples, events, checklist, vendors, contracts, payments, portalSettings, recommendations, orderApprovals, availability, favoriteVendorIds, setRecommendation, toggleAvailability } = useDemoStore()
