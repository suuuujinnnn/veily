...
export function PortalPage() {
  ...
  const settings = portalSettings.find((item) => item.coupleId === couple.id) ?? { coupleId: couple.id, showSchedule: true, showFullEstimate: true, receiveRequests: true, showChecklist: true }
