...
export const initialState: DemoState = {
  ...
  favoriteVendorIds: ['ig-eloonofficial', 'ig-laforetofficial'],
  vendorCatalogGroups: [
    { id: 'catalog-dress-tour', name: '드레스 투어 후보', vendorIds: ['ig-eloonofficial', 'ig-laforetofficial'] },
    { id: 'catalog-studio', name: '자연광 스튜디오', vendorIds: [] },
  ],
  ...
  customerReferenceSubmissions: [{
    ...
    coupleId: 'c1',
    selections: [
      { referenceId: 'ref-ig-laforetofficial-1', note: '깨끗한 실크와 단정한 탑이 좋아요.' },
      { referenceId: 'ref-ig-eloonofficial-1', note: '풍성한 실루엣도 함께 보고 싶어요.' },
    ],
